---- SP QUE SIRVA PARA INSERTAR PRODUCTOS, CON VALIDASIONES---
...
BEGIN
  SP_INSERTA_PRODUCTO('BICICLETA DE MONTANA', 1 , 20, 2019, 4345, MSJ_ERROR, MSJ_EXITO);
...
----- LIMPIANDO CODIGO DESPUES DE CREAR SEQUENCE Y TRIGGER
...
MSJ_EXITO VARCHAR2(500);
BEGIN
  SP_INSERTA_PRODUCTO('BICICLETA DE PRUEBA', 1 , 2, 2019, 1234, MSJ_ERROR, MSJ_EXITO);
  DBMS_OUTPUT.PUT_LINE(MSJ_EXITO || ' ' || MSJ_ERROR);
